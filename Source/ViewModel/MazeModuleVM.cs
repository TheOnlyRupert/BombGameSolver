...
namespace BombGameSolver.Source.ViewModel {
    public class MazeModuleVM : BaseViewModel {
        private static readonly int[,,] MazeList = {
            {
                ...
                {0, 2, 2, 2, 0, 2, 0, 2, 2, 2, 2},
                {1, 2, 1, 0, 1, 2, 1, 0, 1, 0, 1},
                {0, 2, 0, 2, 2, 2, 2, 2, 2, 2, 0},
                {1, 2, 1, 0, 1, 2, 1, 0, 1, 0, 1},
                ...
                /* Maze 2,4 */
                {1, 0, 1, 0, 1, 2, 1, 0, 1, 0, 1},
                {2, 2, 0, 2, 2, 2, 0, 2, 0, 2, 2},
                {1, 0, 1, 2, 1, 0, 1, 2, 1, 0, 1},
                {0, 2, 2, 2, 0, 2, 2, 2, 2, 2, 0},
                {1, 2, 1, 0, 1, 2, 1, 0, 1, 0, 1},
                {0, 2, 0, 2, 2, 2, 0, 2, 2, 2, 0},
                {1, 0, 1, 2, 1, 0, 1, 2, 1, 2, 1},
                {0, 2, 2, 2, 0, 2, 2, 2, 0, 2, 0},
                {1, 2, 1, 2, 1, 2, 1, 0, 1, 2, 1},
                {0, 2, 0, 2, 0, 2, 0, 2, 2, 2, 0},
                {1, 2, 1, 0, 1, 2, 1, 0, 1, 0, 1}
            }, {
                /* Maze 3,2 */
                {1, 2, 1, 0, 1, 0, 1, 0, 1, 0, 1},
        ...
        private void MazeLogic(IReadOnlyList<int> mazeDataUnformatted) {
             ...
             * input 5 -> output 8
             * input 6 -> output 10 */
            for (var i = 0; i < mazeDataUnformatted.Count; i++) {
                mazeData[i] = (mazeDataUnformatted[i] - 1) * 2;
            }

            for (var row = 0; row < MazeList.GetLength(1); row++) {
                // Sets boolean Arrays to default values
                for (var col = 0; col < MazeList.GetLength(2); col++) {
            ...
            for (var row = 0; row < correctPath.GetLength(0); row++) {
                // Sets boolean Arrays to default values
                for (var col = 0; col < correctPath.GetLength(1); col++) {
            ...
            do {
                ...
                /* VERY poor implementation of an infLoop protector */
            ...
            var pos = 0;
            for (var i = 0; i < outputList.Count; i += 2, pos++) {
